...
{
    internal class MappingComposition : VectorComposition, IIntegralTransformation
    {

        IIntegralTransformation mapping;

        IIntegralTransformation injection;

        public MappingComposition(IIntegralTransformation mapping, IIntegralTransformation injection) : base(mapping, injection)
        {
